...
<div style="text-align: center;">
<img src="{{ site.url_ai_images }}/strategy_consulting_apm_selection.svg" alt="Forecasting Power Output POC" height="200"/> <!-- Placeholder image, replace with a more relevant one -->
</div>
